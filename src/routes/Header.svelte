			...
			{#if $page.data.profile?.userId}
				<div class="dropdown-bottom dropdown dropdown-end">
					...
					<label
						...
						class="btn-ghost btn-square btn text-primary-content"
					>
						<i title="Account" class="fa-solid fa-user text-lg" />
					</label>
					<!-- svelte-ignore a11y-no-noninteractive-tabindex -->
					<div tabindex="0" class="dropdown-content rounded-box mt-2 w-52 bg-base-100 shadow-lg">
						<div class="px-4 pt-4">
							<span class="font-bold">@{$page.data.profile.name}</span>
						</div>

						<ul class="menu rounded-box p-2">
							<li>
								<a href="/users/{$page.data.profile.userId}">Profile</a>
							</li>
							<li>
			...
			{:else}
				<div class="dropdown-bottom dropdown dropdown-end">
					...
					<label
						...
						class="btn-ghost btn-square btn text-primary-content"
					>
						<i title="Log In" class="fa-solid fa-right-to-bracket" />
					</label>
					<!-- svelte-ignore a11y-no-noninteractive-tabindex -->
					<div tabindex="0" class="dropdown-content rounded-box mt-2 w-52 bg-base-100 shadow-lg">
						<ul class="menu rounded-box p-2">
							<li><a href="/logto/signin">Sign In</a></li>
						</ul>
					</div>
				</div>
			{/if}
